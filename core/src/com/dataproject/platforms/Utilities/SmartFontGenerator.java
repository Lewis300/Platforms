...
import com.dataproject.platforms.Utilities.BitmapFontWriter;
...
public class SmartFontGenerator {
	...
	private void saveFontToFile(BitmapFont font, int fontSize, String fontName, PixmapPacker packer) {
		...
		com.dataproject.platforms.Utilities.BitmapFontWriter.setOutputFormat(com.dataproject.platforms.Utilities.BitmapFontWriter.OutputFormat.Text);
		com.dataproject.platforms.Utilities.BitmapFontWriter.setOutputFormat(com.dataproject.platforms.Utilities.BitmapFontWriter.OutputFormat.Text);

		String[] pageRefs = com.dataproject.platforms.Utilities.BitmapFontWriter.writePixmaps(packer.getPages(), pixmapDir, fontName);
		...
		com.dataproject.platforms.Utilities.BitmapFontWriter.writeFont(font.getData(), pageRefs, fontFile, new BitmapFontWriter.FontInfo(fontName, fontSize), 1, 1);
	}
