...
{
    private static final Sprite emblem = MiscTools.createScaledSprite(new Texture(Platforms.ROOT+"\\Powerups\\WavePowerupImageScaledUp.png"), Powerup.EMBLEM_WIDTH, Powerup.EMBLEM_HEIGHT);
